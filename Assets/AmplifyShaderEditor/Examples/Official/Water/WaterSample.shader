...
Shader "ASESampleShaders/Water/WaterSample"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime178 = _Time.y * 0.05;
			half2 temp_cast_0 = (mulTime178).xx;
			float2 uv_TexCoord168 = v.texcoord.xy + temp_cast_0;
			float4 color173 = IsGammaSpace() ? half4(0,0,0,0) : half4(0,0,0,0);
			float4 lerpResult172 = lerp( half4( UnpackNormal( tex2Dlod( _TextureSample0, half4( uv_TexCoord168, 0, 0.0) ) ) , 0.0 ) , color173 , _Float1);
			float4 appendResult175 = (half4(0.0 , lerpResult172.r , 0.0 , 0.0));
			v.vertex.xyz += appendResult175.xyz;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half3 temp_cast_1 = (lerpResult130).xxx;
...
/*ASEBEGIN
Version=17000
0;430;1906;589;846.4492;1503.99;2.074133;True;True
...
Node;AmplifyShaderEditor.ScreenDepthNode;1;-1781.601,-154.6997;Float;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;89;-1387.004,-111.5834;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;178;700.8281,404.2694;Float;False;1;0;FLOAT;0.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;154;-922.7065,390.316;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;111;-722.2024,526.6185;Float;False;Property;_FoamDepth;Foam Depth;10;0;Create;True;0;0;False;0;0;660.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;-531.4025,588.5187;Float;False;Property;_FoamFalloff;Foam Falloff;11;0;Create;True;0;0;False;0;0;-1.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;115;-542.0016,452.718;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;106;-830.9032,705.119;Float;False;0;105;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;168;730.6899,199.7003;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;171;1016.04,187.8109;Float;True;Property;_TextureSample0;Texture Sample 0;15;0;Create;True;0;0;False;0;None;77fdad851e93f394c9f8a1b1a63b56f3;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;173;1322.816,316.2933;Float;False;Constant;_Color1;Color 1;16;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;174;1749.789,306.7057;Float;False;Property;_Float1;Float 1;16;0;Create;True;0;0;False;0;0.9;0.931;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;172;1461.089,-31.45641;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-557.3063,-795.3858;Float;False;Property;_NormalScale;Normal Scale;1;0;Create;True;0;0;False;0;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;920.1959,-279.1855;Float;False;Property;_WaterSmoothness;Water Smoothness;7;0;Create;True;0;0;False;0;0;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;104;753.9969,-565.4819;Float;False;Property;_WaterSpecular;Water Specular;6;0;Create;True;0;0;False;0;0;-0.41;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;914.3978,-199.48;Float;False;Property;_FoamSmoothness;Foam Smoothness;13;0;Create;True;0;0;False;0;0;1.63;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;176;1588.432,-228.3213;Float;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;131;756.1969,-467.1806;Float;False;Property;_FoamSpecular;Foam Specular;12;0;Create;True;0;0;False;0;0;0.85;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;170;910.7308,423.9021;Float;False;Property;_Float0;Float 0;14;0;Create;True;0;0;False;0;0.1536368;0.1536368;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;169;1472.932,198.002;Float;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;167;947.6414,112.553;Float;False;1;0;FLOAT;13.06;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;175;1900.955,-77.15493;Float;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;166;1137.444,-29.36095;Float;False;Terrain Wind Animate Vertex;-1;;1;3bc81bd4568a7094daabf2ccd6a7e125;0;3;2;FLOAT4;0,0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.LerpOp;13;60.50008,-220.6998;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-636.2005,-79.20019;Float;False;Property;_WaterFalloff;Water Falloff;5;0;Create;True;0;0;False;0;0;-0.96;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-813.7005,-128.1996;Float;False;Property;_WaterDepth;Water Depth;4;0;Create;True;0;0;False;0;0;1.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;12;-697.5002,-417.5007;Float;False;Property;_DeepColor;Deep Color;2;0;Create;True;0;0;False;0;0,0,0,0;0.07351366,0.1945497,0.2641509,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-455.0999,-328.3;Float;False;Property;_ShalowColor;Shalow Color;3;0;Create;True;0;0;False;0;1,1,1,0;0.2946778,0.6878752,0.8113207,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;97;710.096,-1203.183;Float;False;Property;_Distortion;Distortion;8;0;Create;True;0;0;False;0;0.5;4.08;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E43F55C7F9A6135A21A351EC7F381083477A0421